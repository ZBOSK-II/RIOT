...
(Xilinx Zynq-7020). The processor and all peripherals are implemented in the
...
The RIOT build system uses GRMON as the default programmer:

    make BOARD=zedboard-noelv flash

## Serial console

The APBUART console is available on the USB-UART adapter at 115200 baud.
